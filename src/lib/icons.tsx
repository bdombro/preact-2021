...
export const ChevronL2x = I(() => import('mdi-paths-split/ChevronDoubleLeft'))
export const ChevronR2x = I(() => import('mdi-paths-split/ChevronDoubleRight'))
export const Close = 			I(() => import('mdi-paths-split/Close'))
export const Counter =		I(() => import('mdi-paths-split/Counter'))
export const DotsV = 			I(() => import('mdi-paths-split/DotsVertical'))
...
export const Menu =				I(() => import('mdi-paths-split/MenuOpen'))
export const Person = 		I(() => import('mdi-paths-split/Account'))
