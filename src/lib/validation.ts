...
// export function assertIdentified (auth: AuthCookieContext) {if(!auth.i) throw new ForbiddenError()}
...
export function dupCheck(array: any[]) {
	return new Set(array).size !== array.length
}
export function dupCleanse(array: any[]) {
